...
int main(int argc, char **argv){
    ...
    printf("Fluctuations computation... ");
    ...
    printf("done!\n");
    //HURST EXPONENT
    printf("Computing dfa coefficient... ");
    ...
    free(pn); free(t); free(pn_nomean); free(y); free(s);
    free(F_nu1); free(F_nu2); free(t_fit); free(y_fit); free(diff_vec);
